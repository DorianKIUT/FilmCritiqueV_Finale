...
-- Généré le :  Jeu 19 Avril 2018 à 10:52
...
(104, 10, 'Marion Cotillard', 4, 'Bon acteur', '2018-04-18 20:38:15', 'kledOTP'),
(105, 10, 'Leonardo Di Caprio', 4, 'Il est bon Leonardo dans ce film, un très grand rôle', '2018-04-18 20:38:38', 'kledOTP'),
(106, 10, 'Leonardo Di Caprio', 2, 'Il fait le juste minimum', '2018-04-18 21:09:43', 'kledOTP');
...
(21, 'Batman The Dark Knight', 'Christopher Nolan', 'Super Héros', 'Christian Bale,Michael Caine,Heath Ledger,', 'http://fr.web.img2.acsta.net/medias/nmedia/18/63/97/89/18949761.jpg', 3.9, 'https://youtu.be/EXeTwQWrcwY', 'Dans ce nouveau volet, Batman augmente les mises dans sa guerre contre le crime. Avec l\'appui du lieutenant de police Jim Gordon et du procureur de Gotham, Harvey Dent, Batman vise à éradiquer le crime organisé qui pullule dans la ville. Leur association est très efficace mais elle sera bientôt bouleversée par le chaos déclenché par un criminel extraordinaire que les citoyens de Gotham connaissent sous le nom de Joker.'),
...
(7, 'lebgdu39', 'requin44', 'lerequin@free.fr', NULL);
